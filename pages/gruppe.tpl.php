...
<section>
    <div class="gruppe-title-row">
        ...
        <div class="gruppe-title-knapper">
            ...
            <?php echo url(
                "/gruppe.php?gruppe_id=" . $state["gruppe"]["id"] . "&forlat=1"
            ); ?>"
                    ...
                    <?php foreach ($state["oppgaver"] as $oppgave): ?>
                        <li>
                            <article class="gruppe-oppgaver-oppgave">
                                ...
                                <div>
                                    <?php echo url(
                                        "/oppgave.php?oppgave_id=" . $oppgave["id"]
                                    ); ?>"
                                    >
                                        Åpne
                                    </a>
        ...
        <?php elseif ($state["section"] == "medlemmer"): ?>
            ...
            <section>
                <div class="gruppe-medlemmer-title-row">
                    ...
                    <?php echo url(
                        "/gruppe.php?gruppe_id=" . $state["gruppe"]["id"] . "&inviter=1"
                    ); ?>"
                ...
                <ul>
                    <?php foreach ($state["medlemmer"] as $medlem): ?>
                        <li class="gruppe-medlem">
                            <?php echo htmlspecialchars($medlem["profilbilde"] ?? ""); ?>"
            ...
            <section>
                ...
                <div class="ressurs-tabell-wrapper">
                    <table class="ressurs-tabell">
                        <caption>
                            Ressurser som er designert global i gruppen.
                        </caption>
                        ...
                        <tbody>
                            <?php foreach ($state["ressurser"] as $ressurs): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo (int) ($ressurs["siste_versjon"]["versjon_nummer"] ?? 1); ?>
                                    </td>

                                    <td>
                                        <?php echo url(
                                            "/ressurs.php?fil_id=" . $ressurs["fil_id"]
                                        ); ?>"
                                        >
                                            Åpne
                                        </a>
            ...
            <section>
                ...
                <?php if (
                    ...
                    <p class="gruppe-diskusjon-filter">
                        ...
                        <?php echo url(
                            "/gruppe.php?gruppe_id=" . $state["gruppe"]["id"] .
                            "&section=diskusjoner"
                        ); ?>">
                            Vis alle
                        </a>
                ...
                <ul class="gruppe-diskusjon-liste">
                    <?php foreach ($state["diskusjoner_visning"] as $trad): ?>
                        <li>
                            <?php echo url(
                                "/diskusjon.php?diskusjon_id=" . $trad["id"] .
                                    ($trad["fil_id"] !== null
                                        ? "&fil_id=" . $trad["fil_id"]
                                        : "")
                                ); ?>"
                                ...
                                <span class="gruppe-diskusjon-meta">
                                    ...
                                    <?php if ($trad["oppgave_id"] !== null): ?>
                                        ...
                                        <span class="gruppe-diskusjon-tag">
                                            Oppgave
                                            <?php echo htmlspecialchars($trad["oppgave_id"]); ?>
                                        </span>
                                    ...
                                    <?php elseif ($trad["fil_id"] !== null): ?>
                                        ...
                                        <span class="gruppe-diskusjon-tag">
                                            Fil
                                            <?php echo htmlspecialchars($trad["fil_id"]); ?>
                                        </span>
